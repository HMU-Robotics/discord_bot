...
class Categories(commands.Cog):
    ...
    ## creates secret category
    @category_manage.subcommand(name="create_secret_category",description="Creates hidden category")
    async def category_secret_create(self, interaction: Interaction,category_name:str,textchannel:bool,vchannel:bool):
        guild = interaction.guild
